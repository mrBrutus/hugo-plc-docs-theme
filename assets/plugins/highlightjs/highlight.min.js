...
hljs.registerLanguage("iecst",(()=>{"use strict";var e=e||{};function n(e){
return{aliases:["iecst","scl","stl","structured-text"],name:"Structured Text",
...
}}return e.exports=e=>{e.registerLanguage("iecst",n)
},e.exports.definer=n,e.exports.definer||e.exports})());
hljs.registerLanguage("cio",(()=>{"use strict";return e=>{
var n=[e.C_LINE_COMMENT_MODE,e.COMMENT(/\(\*/,/\*\)/,{relevance:0})];return{
aliases:["cio"],case_insensitive:!0,keywords:{
keyword:"not str out and or mov bmov cnt ",literal:"true false ",
built_in:"part end "},illegal:/"|\$[G-Zg-z]|\/\*|<\/|\|/,contains:[{
className:"string",begin:/'/,end:/'/,contains:[{begin:/''/}]},{
className:"number",relevance:0,variants:[{begin:e.C_NUMBER_RE+"n?"}]}].concat(n)
}}})());
hljs.registerLanguage("inform",(()=>{"use strict";return e=>{
var n=[e.C_LINE_COMMENT_MODE,e.COMMENT(/\(\*/,/\*\)/,{relevance:0})];return{
aliases:["inform"],case_insensitive:!0,keywords:{
keyword:"not str out and or mov bmov cnt ",literal:"true false ",
built_in:"part end "},illegal:/"|\$[G-Zg-z]|\/\*|<\/|\|/,contains:[{
className:"string",begin:/'/,end:/'/,contains:[{begin:/''/}]},{
className:"number",relevance:0,variants:[{begin:e.C_NUMBER_RE+"n?"}]}].concat(n)
